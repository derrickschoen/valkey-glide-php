...
class ValkeyGlideFeaturesTest extends ValkeyGlideBaseTest
{
    ...
    {
        $this->assertEquals(1, ValkeyGlide::OPT_REPLY_LITERAL);
        $this->assertEquals(16, ValkeyGlide::OPT_SERIALIZER);
        $this->assertEquals(17, ValkeyGlide::OPT_PREFIX);
        $this->assertEquals(18, ValkeyGlide::OPT_READ_TIMEOUT);
        $this->assertEquals(19, ValkeyGlide::OPT_SCAN);
        $this->assertEquals(20, ValkeyGlide::OPT_FAILOVER);
        $this->assertEquals(21, ValkeyGlide::OPT_TCP_KEEPALIVE);
        $this->assertEquals(22, ValkeyGlide::OPT_COMPRESSION);
        $this->assertEquals(23, ValkeyGlide::OPT_COMPRESSION_LEVEL);
        $this->assertEquals(24, ValkeyGlide::OPT_NULL_MULTIBULK_AS_NULL);
        $this->assertEquals(25, ValkeyGlide::OPT_MAX_RETRIES);
        $this->assertEquals(26, ValkeyGlide::OPT_BACKOFF_ALGORITHM);
        $this->assertEquals(27, ValkeyGlide::OPT_BACKOFF_BASE);
        $this->assertEquals(28, ValkeyGlide::OPT_BACKOFF_CAP);
        $this->assertEquals(29, ValkeyGlide::OPT_PACK_IGNORE_NUMBERS);
    }
    ...
    {
        // No prefix initially
        $this->assertEquals('', $this->valkey_glide->getOption(ValkeyGlide::OPT_PREFIX));
    ...
    public function testNoOpOptionsAccepted()
    {
        ...
        // OPT_SERIALIZER and OPT_SCAN store their values
    ...
    public function testOptPrefixIsolatedPerInstance()
    {
        ...
        // Second instance should have no prefix
        $this->assertEquals('', $other->getOption(ValkeyGlide::OPT_PREFIX));
    ...
    public function testOptReplyLiteralStillWorks()
    {
        ...
        try {
            // OPT_REPLY_LITERAL is 1 (upstream value) and should still work
            $this->assertFalse($this->valkey_glide->getOption(ValkeyGlide::OPT_REPLY_LITERAL));
